...
namespace FullscreenEditor {
    ...
    public static class Integration {
        ...
        private static string[] GetAllDefines() {
            ...
            var scriptDefines = PlayerSettings.GetScriptingDefineSymbols(namedBuildTarget);
        ...
        private static void SetAllDefines(string[] value) {
            ...
            var currentScriptDefines = PlayerSettings.GetScriptingDefineSymbols(namedBuildTarget);
            ...
            PlayerSettings.SetScriptingDefineSymbols(namedBuildTarget, scriptDefines);
