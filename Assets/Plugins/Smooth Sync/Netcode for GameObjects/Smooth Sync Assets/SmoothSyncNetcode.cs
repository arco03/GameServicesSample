...
namespace Smooth
{
    ...
    public class SmoothSyncNetcode : NetworkBehaviour
    {
        ...
        private bool _triedToExtrapolateTooFar = false;
        ...
        void applyInterpolationOrExtrapolation()
        {
            ...
            _triedToExtrapolateTooFar = false;
            ...
            else if (stateBuffer[0].atPositionalRest && stateBuffer[0].atRotationalRest)
            {
                ...
                if (setVelocityInsteadOfPositionOnNonOwners) _triedToExtrapolateTooFar = true;
            }
                ...
                !isSmoothingAuthorityChanges)
            {
                ...
                _triedToExtrapolateTooFar = !success;
            ...
            if (!_triedToExtrapolateTooFar)
            {
                ...
                bool changedScaleEnough = getScale() != targetTempState.scale;
            ...
            else if (_triedToExtrapolateTooFar)
            {
                if (hasRigidbody)
                {
